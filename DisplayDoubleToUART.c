...
int main(void) {
	...
	while (1) {
		    ...
		    double roundednum;
		    uint16_t intpart;
		    uint8_t myarray[6]; //Ширина (общее количество знаков в выводе (исключая точку)
		    ...
		    uint8_t dpp = 1; //Положение (индекс) десятичной точки
		    ...
		    myarray[0] = (IntVal / 1000000);
		    myarray[1] = (IntVal % 1000000) / 100000;
		    myarray[2] = (IntVal % 100000) / 10000;
		    myarray[3] = (IntVal % 10000) / 1000;
		    myarray[4] = (IntVal % 1000) / 100;
		    myarray[5] = (IntVal % 100) / 10;
		    myarray[6] = (IntVal % 10);
